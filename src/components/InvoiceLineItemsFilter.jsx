...
import { TextInput, NumberInput, GRID_RESPONSIVE_STANDARD } from "@openimis/fe-core";
import { CONTAINS_LOOKUP, DEFUALT_DEBOUNCE_TIME } from "../constants";
import { defaultFilterStyles } from "../util/styles";

const StyledInvoiceLineItemsFilter = styled('div')(({ theme }) => ({
  ...defaultFilterStyles(theme),
}));

const InvoiceLineItemsFilter = ({ filters, onChangeFilters }) => {
...
export default InvoiceLineItemsFilter;
